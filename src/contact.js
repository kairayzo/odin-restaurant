...
export default function Contact () {
    ...
    const phoneImg = generateElement('img','img-phone','images/contact/phone_graphic.png','Phone Icon')
    ...
    const TVImg = generateElement('img','img-TV','images/contact/TV_graphic.png','Television Icon')
    ...
    const CarImg = generateElement('img','img-car','images/contact/car_graphic.png','Car Icon')
    ...
    const mapImg = generateElement('img','img-map','images/contact/map_graphic.jpg',"Map to Freddy's Pizzaria")
